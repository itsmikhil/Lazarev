  ...
  return (
    <div className="intro-text flex flex-col justify-center items-center gap-[2vh]">
      <span className="overflow-hidden inline-block">
        <h1 className="text-[9vw] text-center font-extrabold leading-none tracking-tighter xl:text-[8vw] lg:text-[5vw] ">
          AI & ML PR
        ...
        <p className="w-[35%] text-center text-[1.2vw] leading-none xl:text-[1.5vw] lg:text-[3vw] ">
          <span className="">
        ...
        <p className="w-[37%] text-center text-[1.2vw] leading-none md:flex md:flex-col md:w-fit">
